...
export function render(v,{roundPages=[],codexLinks=false,live=false}={}) {
 ...
 <a href="#main" class="skip">跳到工作区</a><header class="top"><div class="brand"><span class="brand-mark" aria-hidden="true">tr</span>codex team runtime</div><div class="top-meta"><span class="mono">${esc(v.team.id)}</span><span class="pill neutral">${live?'最新工作台 · 只读':'只读快照'}</span></div></header>
